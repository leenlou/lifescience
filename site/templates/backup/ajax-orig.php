...
function healthTest()
{
    ...
    switch (strtolower($question)) {
        case 'what is your desired outcome?':
            $programs = [
                'Be healthier' => [
                    'signature-programs/core-nutrition-program',
                    'health-and-wellness-services/customized-nutraceutricals',
                ],
                'Lose weight' => [
                    'signature-programs/weight-and-metabolic-management',
        ...
        case 'why do you want to eat healthier?':
            $programs = [
                ...
                'Improve athletic performance' => [
                    'signature-programs/inherited-disease-screening-intervention',
