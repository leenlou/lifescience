...
<div id="myModal1" class="modal">
  ...
  <div class="modal-content"><span class="close">&times;</span>
	...
	<form name="chp" action="/programs/signature-programs/core-nutrition-program" method="POST">
...
<div id="myModal2" class="modal">
  ...
  <div class="modal-content"><span class="close">&times;</span>
	...
	<form name ="gpi" action="/programs/signature-programs/inherited-disease-screening-intervention" method="POST">
...
<div id="myModal4" class="modal">
  ...
  <!-- Modal content -->
  <div class="modal-content"><span class="close">&times;</span>
  	<h1 class="heading service-heading service-heading--green ess">ESSENTIAL OPTIMUM WEIGHT MANAGEMENT PROGRAM</h1>
  	<h1 class="heading service-heading service-heading--green adv">ADVANCED OPTIMUM WEIGHT MANAGEMENT PROGRAM</h1>
  	<h1 class="heading service-heading service-heading--green com">COMPREHENSIVE OPTIMUM WEIGHT MANAGEMENT PROGRAM</h1>

    <div class="service-description modal-pad">
    <h2>Optimum Weight Management for men and women</h2>
	...
	<div id="essow">
		<p><strong><em>Essential Optimum Weight Management Program</em></strong>  assesses the hormone levels and nutritional factors that affect weight management. It identifies the body’s reaction to specific food items, and evaluates the body’s intestinal health. Test includes: Food Intolerance Test (FIT), Organic Acid Test (OAT), and Comprehensive Hormones Plus.</p>
	</div>
	<div id="advow">
		<p><strong><em>Advanced Optimum Weight Management Program</em></strong> assesses the hormone levels, and nutritional factors that affect weight management such as vitamin and mineral factors affecting amino acid metabolism and protein digestion; Vitamin D related concerns such as bone health, and fat absorption; reaction to specific food items; and intestinal health. Test includes: Food Intolerance Test (FIT), Organic Acid Test (OAT), Amino Acid Test, Vitamin D Test, and Comprehensive Hormone Plus.</p>
	</div>
	<div id="comow">
		<p><strong><em>Comprehensive Optimum Weight Management Program</em></strong> assesses hormone levels, and factors affecting gut health such as reaction to specific food items, intestinal function, amino acid metabolism, adequacy of Vitamin D levels, plus comprehensive stool test to determine the presence of microorganisms such as yeast, parasites, and bacteria that contribute to chronic illness and neurological dysfunction; and Gluten/Casein Peptide test to determine the body’s inability to digest wheat, rye, barley, and milk. Test includes: Food Intolerance Test (FIT), Organic Acid Test (OAT), Amino Acid Test, Vitamin D Test, Comprehensive stool analysis, Gluten/ Casein Peptide Test, and Comprehensive Hormone Plus.</p>
	</div>
	<p><strong>Target Audience</strong></p>
	...
	<form name="owmp" action="/programs/signature-programs/weight-and-metabolic-management" method="POST">
