...
<div id="myModal1" class="modal">
  ...
  <div class="modal-content"><span class="close">&times;</span>
	...
	<p>This program determines the effects of certain food on your body. Its objective is to help your body get the most out of the food and supplements you take to boost energy, and address common symptoms such as migraines, insomnia, chronic fatigue, or a declining immune system.</p>
	<div id="essch">
		<p><strong><em>Essential Core Health Program</em></strong> identifies your body’s reaction to specific food items and evaluates your intestinal health, which could be causing some of your current symptoms, and may trigger potential health issues. Tests include: Food Intolerance Test (FIT), and Organic Acid Test (OAT).</p>
	</div>
	<div id="advch">
		<p><strong><em>Advanced Core Health Program</em></strong> looks at how vitamins and minerals affect your metabolism and digestion. Tests include: Food Intolerance Test (FIT), Organic Acid Test (OAT), Amino Acid Test, and Vitamin D test.</p>
	</div>
	<div id="comch">
		<p><strong><em>Comprehensive Core Health Program</em></strong> looks at all the factors that affect your gut health. Tests and treatments include those in the Essential Core Health and Advanced Core Health programs. In addition, this program includes: a comprehensive stool test that checks for the presence of microorganisms that contribute to chronic illness and neurological dysfunction; and a Gluten/Casein Peptide test to assess your body’s ability to digest wheat, rye, barley, and milk.</p>
	</div>
...
like cancer.</p>
	...
	<p><strong>Who this program is for</strong></p>
	<p>Individuals with a family history of diseases such as cancer, heart disease, diabetes, and so on.</p>
	<p><strong>Expected Benefits</strong></p>
	<p>Screening and Prevention of potentially inherited diseases, Effective Treatment of diseases that run in the family, Improved quality of life, Optimal health.</p>
...
<div id="myModal4" class="modal">
  ...
  <div class="modal-content"><span class="close">&times;</span>
	...
	<div id="essow">
		<p><strong><em>Essential Optimal Weight Management Program</em></strong> assesses the hormone levels and nutritional factors that affect weight management. It identifies your body’s reaction to specific food items, and evaluates your intestinal health. Tests include: Food Intolerance Test (FIT), Organic Acid Test (OAT), and Comprehensive Hormones Plus.</p>
	</div>
	<div id="advow">
		<p><strong><em>Advanced Optimal Weight Management Program</em></strong> assesses the hormone levels and nutritional factors that influence weight management, such as vitamin and mineral intake which affects amino acid metabolism and protein digestion; Vitamin D related concerns such as bone health, and fat absorption; reaction to specific food items; and intestinal health. Tests include: Food Intolerance Test (FIT), Organic Acid Test (OAT), Amino Acid Test, Vitamin D Test, and Comprehensive Hormone Plus.</p>
	</div>
	<div id="comow">
	...
	<p><strong>Who this program for</strong></p>
	<p>Individuals suffering from: obesity, visceral adiposity, or resistant weight loss; people undergoing menopause, andropause, or thyropause.</p>
	<p><strong>Expected Benefits</strong></p>
